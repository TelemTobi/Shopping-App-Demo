...
public struct WormTabStripStylePropertyies {
    ...
    var kMinimumWormHeightRatio:CGFloat = 5/5
    ...
    //color for worm
    var WormColor:UIColor = .secondaryColor
...
public class WormTabStrip: UIView,UIScrollViewDelegate {
    ...
    private var tabs:[WormTabStripView]! = []
...
//        topScrollView.frame = CGRect(x: 0,y: 90, width:Width,height:eyStyle.kHeightOfTopScrollView)
    ...
    private func buildTopScrollViewsContent(){
        ...
        for i in 0..<delegate!.WTSNumberOfTabs(){
            ...
            let tab:WormTabStripView = WormTabStripView()
            tab.index = i
    ...
    ***************************************/
     ...
     ********/
     @objc func tabPress(sender:AnyObject){
        ...
        let tab:WormTabStripView = tap.view as! WormTabStripView
        selectTab(tab: tab)
    }
     ...
     ********/
    private func natruallySlideWormToPosition(tab:WormTabStripView){
    ...
    *********************/
    private func adjustTopScrollViewsContentOffsetX(tab:WormTabStripView){
    ...
    func centerCurrentlySelectedWorm(tab:WormTabStripView){
        //check the settings
    ...
    ******************************************/
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        }else if currentX < contentScrollContentOffsetX {
...
//        return worm.frame.height
    ...
    private func makePrevTabDefaultStyle(){
        ...
        tab.label.textColor = eyStyle.tabItemDefaultColor
        tab.label.font = eyStyle.tabItemDefaultFont
    }
    
    private func makeCurrentTabSelectedStyle(){
        let tab = tabs[currentTabIndex]
        tab.label.textColor = eyStyle.tabItemSelectedColor
        tab.label.font = eyStyle.tabItemSelectedFont
    }
    /*************************************************
